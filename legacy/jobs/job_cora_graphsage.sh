...
cp "$0" "${RESULT_DIR}/job_cora_graphsage_${JOB_ID}.sh" 2>/dev/null || true
...
tar -czf "${ARCHIVE_DIR}/cora_graphsage_results_${JOB_ID}.tar.gz" \
    -C "${RESULT_DIR}" . \
...
echo "  ${RESULT_DIR}/results_cora_graphsage_classification.csv"
echo "  ${RESULT_DIR}/results_cora_graphsage_classification_summary.csv"
echo "  ${RESULT_DIR}/results_cora_graphsage_classification_report.pdf ou .html"
