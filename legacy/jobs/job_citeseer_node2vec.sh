#!/bin/bash
#SBATCH --job-name=citeseer_node2vec_cls
#SBATCH --chdir=/scratch/rdongmo/IDP-LS/k-Anonymization
#SBATCH --output=logs/citeseer_node2vec_%j.out
#SBATCH --error=logs/citeseer_node2vec_%j.err
...
RESULT_DIR="resultat/citeseer_node2vec_classification_k_sweep"
PLOTS_DIR="plots_citeseer_node2vec"
LOG_FILE="logs/citeseer_node2vec_${JOB_ID}_${RUN_TIMESTAMP}.log"
...
REPORT_PDF="${RESULT_DIR}/results_citeseer_node2vec_classification_report.pdf"
REPORT_HTML="${RESULT_DIR}/results_citeseer_node2vec_classification_report.html"
DETAILED_CSV="${RESULT_DIR}/results_citeseer_node2vec_classification.csv"
SUMMARY_CSV="${RESULT_DIR}/results_citeseer_node2vec_classification_summary.csv"
EXPECTED_PLOTS=(
...
echo "========================================================"
echo "JOB Citeseer --- Node2Vec + Logistic Regression Classification"
echo "Job ID   : ${JOB_ID}"
echo "Noeud    : $(hostname)"
echo "Demarre  : $(date)"
...
echo "========================================================"
echo "PIPELINE Citeseer Node2Vec"
echo "Demarre : $(date)"
echo "========================================================"
