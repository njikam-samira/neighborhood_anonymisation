...
REPORT_PDF="${RESULT_DIR}/results_cora_gat_classification_report.pdf"
REPORT_HTML="${RESULT_DIR}/results_cora_gat_classification_report.html"
DETAILED_CSV="${RESULT_DIR}/results_cora_gat_classification.csv"
SUMMARY_CSV="${RESULT_DIR}/results_cora_gat_classification_summary.csv"
EXPECTED_PLOTS=(
