#!/bin/bash
#SBATCH --job-name=citeseer_graphsage_cls
#SBATCH --chdir=/scratch/rdongmo/IDP-LS/k-Anonymization
#SBATCH --output=logs/citeseer_graphsage_%j.out
#SBATCH --error=logs/citeseer_graphsage_%j.err
...
RESULT_DIR="resultat/citeseer_graphsage_classification_k_sweep"
PLOTS_DIR="plots_citeseer_graphsage"
LOG_FILE="logs/citeseer_graphsage_${JOB_ID}_${RUN_TIMESTAMP}.log"
...
DATA_PAIRS="data/citeseer.pairs"
DATA_FALLBACK_CANDIDATES=("secGraph/data/citeseer.pairs" "kdld/data/citeseer.pairs" "umga/data/citeseer.pairs")
REPORT_PDF="${RESULT_DIR}/results_citeseer_graphsage_classification_report.pdf"
REPORT_HTML="${RESULT_DIR}/results_citeseer_graphsage_classification_report.html"
DETAILED_CSV="${RESULT_DIR}/results_citeseer_graphsage_classification.csv"
SUMMARY_CSV="${RESULT_DIR}/results_citeseer_graphsage_classification_summary.csv"
EXPECTED_PLOTS=(
...
echo "========================================================"
echo "JOB Citeseer --- GraphSAGE Classification"
echo "Job ID   : ${JOB_ID}"
echo "Noeud    : $(hostname)"
echo "Demarre  : $(date)"
...
echo "[CHECK] Dependances Python critiques (GraphSAGE) :"
python3 - <<'PY'
import importlib
import sys
...
try:
    ...
    missing.append(f"torch_geometric.nn.SAGEConv: {exc}")
...
print("[OK] Dependances GraphSAGE disponibles.")
PY
...
echo "========================================================"
echo "PIPELINE Citeseer GraphSAGE"
echo "Demarre : $(date)"
echo "========================================================"
